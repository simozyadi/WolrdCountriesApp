sudo docker run -d -p 3306:3306 --name=mysqlsimo --env="MYSQL_ROOT_PASSWORD"="pass123" mysql

connect to mysql database inside the container
docker exec -it mysqlsimo mysql -uroot -p

CREATE DATABASE world; //create the database world
